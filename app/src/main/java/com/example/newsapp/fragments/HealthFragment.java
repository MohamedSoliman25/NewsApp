...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newsViewModel.getHealthNews(Constants.country,category,100,api);
        newsViewModel.getHealthMutableLiveData().observe(getActivity(), new Observer<ArrayList<NewsModel>>() {
            @Override
...
//    }
    ...
    public void onStop() {
      ...
      //  newsViewModel.compositeDisposable.clear();
        ...
        ///newsViewModel.getHealthMutableLiveData().removeObservers(getViewLifecycleOwner());
    }
}